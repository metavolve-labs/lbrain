...
def non_default(name: str, value):
    ...
    if isinstance(value, list):
        # `sources` is the only list of Paths; the disclosure allowlists and the
        # exclusion markers (Wave 0, 2026-09-05) are
        ...
        if name in ("allowed_doc_types", "allowed_path_prefixes", "exclude_path_markers"):
            return ["TOPIC-AREA/"]
