...
class Config:
    ...
    keyword_decisive_tau: float | None = None  # PHASE 1b (#61): if BM25 top-1/top-2 margin >= tau, the keyword top-1 takes fused position 1. None = off (pure RRF).
    ...
    def load(cls) -> "Config":
        ...
        return cls(
            ...
            keyword_decisive_tau=raw.get("keyword_decisive_tau", cls.keyword_decisive_tau),
